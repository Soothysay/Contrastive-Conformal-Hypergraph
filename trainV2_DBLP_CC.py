...
parser.add_argument('--dataset', type=str, default='dblp', choices = ['house-bills', 'house-committees', 'walmart-trips','cora','dblp', 'citeseer', 'pubmed','congress-bills']) #'house-bills'
parser.add_argument('--types', type=str, default='CA', choices = [None, 'CA', 'CF'])
...
parser.add_argument('--size_loss_weight', type=float, default=3)
...
parser.add_argument('--late_contrastive_loss_weight', type=float, default=0.1)
